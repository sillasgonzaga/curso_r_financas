...
O objeto é das classes `xts` e `zoo`, que eram muito usadas no passado. Atualmente, tem-se preferido usar dados na classe data.frame. Contudo, muitos pacotes ainda usam o `xts` como classe principal, sendo assim importante conhecer essas classes.
